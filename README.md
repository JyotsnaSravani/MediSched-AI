...
* Automated voice call interactions
* SMS reminders and notifications
* Appointment rescheduling and cancellation
* Real-time slot validation
* Call recording and auditing
* Speech-to-text transcription using Whisper
* Centralized dashboard for monitoring appointments and communications
* Secure and scalable healthcare workflow automation
